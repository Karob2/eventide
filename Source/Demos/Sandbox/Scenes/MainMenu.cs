...
namespace Sandbox.Scenes
{
    public class MainMenu : Scene
    {
        ...
        public static void MCSelect(Entity entity)
        {
            entity.TextState.Color = Color.White;
        }
        public static void MCDeselect(Entity entity)
        {
        ...
        public static void MCConfig(Entity entity)
        {
            Scene.AddScene(new MenuConfig());
        }
        public static void MCExit(Entity entity)
        {
