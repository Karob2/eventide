...
namespace Sandbox.Scenes
{
    public class ConsoleScene : Scene
    {
        ...
        public ConsoleScene() : base(false)
        {
            ...
            logText = new Entity(this, entityList).AddText("system:default", "", 5f, 25f, Color.White, 1f);
            inputText = new Entity(this, entityList).AddText("system:default", "", 5f, 205f, Color.Cyan, 1f);
            inputMessage = new StringBuilder("");
            logBox = new Entity(this, entityList).AddTextBox("system:default", 0f, 0f, 100f, 100f, 5f, Color.White, "");
