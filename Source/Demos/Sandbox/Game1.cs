...
namespace Sandbox
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Scene.Initialize();
            Scene.ChangeScene(new Scenes.MainMenu());
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            Scene.UpdateSceneControl();
            Scene.UpdateScenePhysics();

            if (GlobalServices.InputManager.JustPressed(GameCommand.Console))
            {
                // TODO/BUGFIX: Prevent opening a console screen on top of a console screen (via multiple ~ presses).
                Scene.AddScene(new Scenes.ConsoleScene());
            }
